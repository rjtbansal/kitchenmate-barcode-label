  ...
  try {
    ...
    const recipesData = recipesDataReceived.data.map(
      ({
        ...
        side_photo,
        nutrition: { allergens },
      }) => ({ id, name, category, summary, side_photo, allergens, barcodeURL: "https://generator.barcodetools.com/barcode.png?gen=0&data=1234567&bcolor=FFFFFF&fcolor=000000&tcolor=000000&fh=14&bred=0&w2n=2.5&xdim=2&w=&h=120&debug=1&btype=7&angle=0&quiet=1&balign=1&talign=2&guarg=1&text=1&tdown=0&stst=1&schk=0&cchk=1&ntxt=1&c128=0" })
    );
